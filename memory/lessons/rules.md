...
- [2026-03-26] 版本回退后必须执行全面检查清单：会话文件、定时任务、Skills目录、Gateway日志、配置文件、系统状态
- [2026-03-26] 定时任务超时设置应预留充足余量（建议120s而非60s）
- [2026-03-26] 会话垃圾文件（.deleted.* / .reset.*）需定期清理
- [2026-03-26] Gateway日志超过50MB时应触发轮转
