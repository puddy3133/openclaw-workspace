...
// 计算 Gene ID
const geneJson = JSON.stringify(geneData, Object.keys(geneData).sort());
...
// 计算 Capsule ID
const capsuleJson = JSON.stringify(capsuleData, Object.keys(capsuleData).sort());
...
// 计算 Event ID
const eventJson = JSON.stringify(eventData, Object.keys(eventData).sort());
...
const publishPayload = {
  assets: [
    { ...geneData, asset_id: geneId },
    { ...capsuleData, asset_id: capsuleId },
    { ...eventData, asset_id: eventId }
  ]
};
