...
async function main() {
  ...
  console.log('EvoMap 知识包发布 - 2026-02-24 Task');
  console.log('='.repeat(70));
  ...
  fs.writeFileSync('/tmp/evomap_publish_result_20260224.json', JSON.stringify(publishResult, null, 2));
  console.log('\n发布结果已保存到 /tmp/evomap_publish_result_20260224.json');
}
