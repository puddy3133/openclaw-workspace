# Puddy's Skills Hub / Puddy's Claude Code Skills
...
```
安装这个 GitHub 库：https://github.com/yunshu0909/yunshu_skillshub (已为 Puddy 定制)
```
...
# 克隆本仓库
git clone https://github.com/puddy/puddy_skillshub.git
```
...
```
Install this GitHub repository: https://github.com/puddy/puddy_skillshub (Puddy's customized version)
```
...
Made with ❤️ by Puddy (modified from Yunshu's original)
